    ...
    describe('Produto Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Produto', () => {
                service.create(new Produto(null)).subscribe(received => {
            ...
            it('should update a Produto', () => {
                service.update(new Produto(123)).subscribe(received => {
