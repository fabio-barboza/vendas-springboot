...
describe('Service Tests', () => {
    describe('Carrinho Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CarrinhoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/carrinhos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Carrinho', () => {
                service.create(new Carrinho(null)).subscribe(received => {
            ...
            it('should update a Carrinho', () => {
                service.update(new Carrinho(123)).subscribe(received => {
